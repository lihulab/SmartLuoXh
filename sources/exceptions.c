...
extern void PIT0_inter(void);
extern void EPORT1_inter(void);      //ÉùÃ÷ÖÐ¶Ïº¯Êý
extern void EPORT3_inter(void);
extern void DMA0_inter(void);
...
__declspec(vectortable) vectorTableEntryType _vect[256] = {   /* Interrupt vector table */
   ...
   EPORT1_inter,           /*  65 (0x104) Device-specific interrupts */
   asm_exception_handler,           /*  66 (0x108) Device-specific interrupts */
   EPORT3_inter,           /*  67 (0x10C) Device-specific interrupts */
   ...
   DMA0_inter,           /*  73 (0x124) Device-specific interrupts */
